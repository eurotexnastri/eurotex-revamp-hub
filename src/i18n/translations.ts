...
export const translations = {
  en: {
    ...
    home: {
      ...
      tagline: 'Expertise and Technology Since 1973',
      exploreProducts: 'Explore Products',
      getInTouch: 'Get in Touch',
      over50Years: 'Over 50 Years of Excellence',
      intro: 'Since 1973, Eurotex has been a leading Italian manufacturer of high-quality technical webbings and narrow fabrics. Our products serve diverse industries including automotive, fashion, medical, military, and sports. With state-of-the-art machinery and rigorous quality control, we deliver solutions that meet the most demanding specifications.',
